...
export default function RatingNotesModal(props: RatingNotesModalProps) {
  ...
  // Convert currentNotes to a safe string, handling all edge cases
  const safeCurrentNotes = (() => {
    if (currentNotes === null || currentNotes === undefined) return '';
    if (typeof currentNotes === 'string') return currentNotes;
    // Handle any other data type (like numbers) that might have been passed
    return String(currentNotes);
  })();
